...
LANG_TEXT = {
    "EN": {
        ...
        "log_destroy_prepare": lambda p: f"🎯 {p} preparing Destroy: select opponent's hand card to destroy.",
    ...
    "ZH": {
        ...
        "log_destroy_prepare": lambda p: f"🎯 {p} 准备销毁：选择对手手牌区的牌。",
            ...
            # 情况 A：如果这是我自己的手牌区，且轮到我的回合，渲染「出牌」按钮
                    ...
                    # Destroy — costs 1 AP
                                ...
                                if state["ap"] > 0:
                                    ...
                                    add_log(
                                        state,
                                        T["log_destroy_prepare"](p_name_display),
                                    )
                                    save_game(room_code, state)
                                    st.rerun()
                                else:
